 ...
 * the "led.txt" file, which must be in the "/firmware/"
 ...
 */
public enum PanelLED implements ConsoleIdMaps.Aliased {
    ...
    ch0_nbch_RecReadyProxy("nbch_RecReadyProxy"),
    ch0_chp_Select("chp_Select"),
    ch0_chp_Solo("chp_Solo"),
    ch0_chp_Mute("chp_Mute"),
    ch0_chp_GreenDot("chp_GreenDot"),
    ch0_chp_RedDot("chp_RedDot"),
    ch0_chp_Assign("chp_Assign"),
    ch0_chp_Write("chp_Write"),
